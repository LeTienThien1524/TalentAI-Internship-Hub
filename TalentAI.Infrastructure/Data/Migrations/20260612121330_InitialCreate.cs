        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InternshipDurationMonths = table.Column<int>(type: "int", nullable: false),
                    SalaryAllowance = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIParsedResumes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AIParsedResumes_Resumes_ResumeId",
                        column: x => x.ResumeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoreStrengths = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SkillGaps = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIMatchScores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AIMatchScores_JobApplications_JobApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationHistories_JobApplications_JobApplicationId",
                        column: x => x.JobApplicationId,
                        principalTable: "JobApplications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationOrLink = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    InterviewerName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIMatchScores_JobApplicationId",
                table: "AIMatchScores",
                column: "JobApplicationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AIParsedResumes_ResumeId",
                table: "AIParsedResumes",
                column: "ResumeId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationHistories_JobApplicationId",
                table: "ApplicationHistories",
                column: "JobApplicationId");
